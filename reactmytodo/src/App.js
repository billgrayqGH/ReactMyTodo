...
var todos = [
  {
    todoTitle: 'Clean my room',
    todoResponsible: 'Vince',
    todoDescription: 'clean bed',
    todoPriority: 'high'
  },
  {
    todoTitle: 'Wash dishes',
    todoResponsible: 'Annie',
    todoDescription: 'clean sink',
    todoPriority: 'medium'
  },
  {
    todoTitle: 'Study Programming',
    todoResponsible: 'Keith',
    todoDescription: 'Study to pass exam',
    todoPriority: 'high'
  }
]
    ...
    return (
      <div className="container">
        ...
        <div className="page-header">
          <h1>React Sample Todo List Application <small>by Bill Gray Quitalig</small></h1>
        </div>
        <TodoInput
